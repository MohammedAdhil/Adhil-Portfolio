      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            ...
            <AnimatedBody
              text={
                "I am a highly skilled full stack web developer with significant professional experience. I excel in collaborative environments and thrive in agile development processes, having successfully contributed to projects in various industries, including technology.I am deeply passionate about crafting responsive, user-friendly websites that captivate users with their visual appeal and ease of navigation. My ultimate goal is to continue my growth as a developer by taking on challenging projects that push me to continually learn and enhance my skills."
              }
            />
            <AnimatedBody
              text={
          ...
          <div className="mb-24 flex w-[100%] flex-col gap-4 text-[18px] font-normal leading-relaxed tracking-wide text-[#e4ded7]/80 sm:mb-32 md:mb-40 md:gap-6 md:text-[16px] md:leading-normal lg:mt-0 lg:mb-16 lg:max-w-[30%] lg:text-[18px]">
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimatedBody
                text={
                  "JavaScript(ES6+), React, Next.js, TypeScript, Redux, Redux Toolkit, React Testing Library, Vitetest, HTML5, Git/GitHub, NextAuth, Jira."
                }
              />
            </div>
