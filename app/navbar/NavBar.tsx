...
const NavBar = () => {
  ...
  return (
    <nav className="fixed bottom-10 left-0 right-0 z-50 my-0  mx-auto  flex w-[356px] items-center justify-center gap-1 rounded-lg bg-[#07070a]/90 px-1 py-1 text-[#e4ded7] backdrop-blur-md sm:w-[483.3px] md:p-2 lg:w-[500.3px]">
      <Link
      ...
      <Link
        ...
        data-blobity-magnetic="false"
        onClick={handleScroll}
        aria-label="Scroll to Certification Section"
      >
        <h4 className="rounded py-2 px-2 sm:px-4 text-[12px] sm:text-[14px] md:py-1 md:px-4">
          Certification
        </h4>
